...
class AppColors {
  ...
  // Condition badge colors — "good" / "bad" (from classification)
  static const Color conditionGood = Color(0xFF2E7D32);
  static const Color conditionBad = Color(0xFFC62828);

  static Color forCondition(String condition) {
    return condition == 'bad' ? conditionBad : conditionGood;
  }
}
